...
public class ConnectDeviceActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        view_data_btn = findViewById(R.id.btn_view_data);
        send_data_btn = findViewById(R.id.btn_send_data);
        view_data_btn.setOnClickListener((v -> view_data_page()));
        send_data_btn.setOnClickListener((v -> send_data_page()));
    }
    ...
    public void view_data_page()
    {
        startActivity(new Intent(ConnectDeviceActivity.this,ViewData_activity.class));
    }

    public void send_data_page()
    {
        ...
        {
            startActivity(new Intent(ConnectDeviceActivity.this, Send_Data_activity.class));
        }
    }

...
//        startActivity(intent);
        ...
        startActivity(new Intent(HomeActivity.this,LoginActivityNew.class));
        finish();
    }
    ...
    public void getReadings(String date) {
        ...
        SharedPreferences sharedPreferences =
                getSharedPreferences(Constants.SharedPrefConstants.SHARED_PREF_NAME, Context.MODE_PRIVATE);
        String deviceID =
                sharedPreferences.getString(Constants.SharedPrefConstants.BLE_ADDRESS, "");
        Call<ReadingsNew> call =
                apiService.getReading(deviceID, date);
            ...
            public void onResponse(Call<ReadingsNew> call, Response<ReadingsNew> response) {
                if (response.body() != null) {
                    ...
                    for (int i = 0; i < 7; i++) {
                        ...
                        } else if (i == 6) {dateHelper.endDate(date);
                        }
                        ...
                        //TODO: this is probably where the data is being saved
...
//                else
//                {
//                    Toast.makeText(HomeActivity.this, "Failed to add note", Toast.LENGTH_SHORT).show();
//                }
//            }
//        });
//
